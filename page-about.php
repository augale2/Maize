...
<main class="mx-auto p-4 sm:p-6 lg:p-8">
    <div class="space-y-12">
        ...
        <section class="space-y-6">
            <h2 class="text-3xl font-semibold">The Genetic Stock Collection</h2>
            <p>
        ...
        <section class="space-y-6">
            <h2 class="text-3xl font-semibold">The Services Provided</h2>
            <p>
        ...
        <section class="space-y-6">
            <h2 class="text-3xl font-semibold">The value of the stocks</h2>
            <p>
        ...
        <section class="space-y-6">
            <h2 class="text-3xl font-semibold">Changing Requirements and Future Planning</h2>
            <p>
