...
<main class="mx-auto p-4 sm:p-6 lg:p-8 max-w-7xl">
    <div class="space-y-12">
        <section class="space-y-6">
            <h1 class="text-4xl text-gray-800 font-bold">Annual Report Summary</h1>
        </section>
        ...
        <section class="space-y-6">
            <h2 class="text-3xl text-gray-800 font-semibold">Special Plantings were made for the following stocks:</h2>
        ...
        <section class="space-y-6">
            <h2 class="text-3xl text-gray-800 font-semibold">Additional Stock Donations</h2>
            <p class="text-lg text-gray-600 leading-relaxed">
        ...
        <section class="mt-8 border-t pt-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4 text-center">
                <div>
                    <p class="text-lg text-gray-800 font-semibold">Marty Sachs</p>
                    <p class="text-lg text-gray-600">Director</p>
                </div>
                <div>
                    <p class="text-lg text-gray-800 font-semibold">Jeff Gustin</p>
                    <p class="text-lg text-gray-600">Curator</p>
                </div>
                <div>
                    <p class="text-lg text-gray-800 font-semibold">Shane Zimmerman</p>
                    <p class="text-lg text-gray-600">Agric Sci Res Tech (Plants)</p>
                </div>
                <div>
                    <p class="text-lg text-gray-800 font-semibold">Josh Tolbert</p>
                    <p class="text-lg text-gray-600">Information Tech Specialist</p>
                </div>
            </div>
        </section>
    </div>
